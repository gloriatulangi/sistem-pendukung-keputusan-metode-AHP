					...
					<tr align="center">
						...
						<?php
							...
							foreach ($sub_kriteria as $keys):
								$nilai_prioritas = $this->Perhitungan_model->prioritas_subkrit($keys->id_nilai,$key->id_kriteria,$keys->id_sub_kriteria);
...
<div class="card shadow mb-4">
    <!-- /.card-header -->
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-table"></i> Data Penilaian Siswa</h6>
    </div>
