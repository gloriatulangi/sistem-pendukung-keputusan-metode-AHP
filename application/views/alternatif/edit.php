		...
		<div class="card-body">
			<div class="row">
				...
				<div class="form-group col-md-12">
					...
					<input autocomplete="off" type="text" name="kelas" value="<?php echo $alternatif->kelas ?>" required class="form-control"/>
				</div>
				<div class="form-group col-md-12">
					<label class="font-weight-bold">Jurusan</label>
					<input autocomplete="off" type="text" name="jurusan" value="<?php echo $alternatif->jurusan ?>" required class="form-control"/>
				</div>
			</div>
		</div>
